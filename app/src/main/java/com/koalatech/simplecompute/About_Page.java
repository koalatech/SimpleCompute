...
import com.koalatech.simplecompute.util.util.SystemUiHider;
...
public class About_Page extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.about_back_button).setOnTouchListener(mDelayHideTouchListener);
    }
    ...
    protected void onPostCreate(Bundle savedInstanceState) {
        ...
        Button Back_Button = (Button) findViewById(R.id.about_back_button);
